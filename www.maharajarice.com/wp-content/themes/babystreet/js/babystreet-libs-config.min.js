(function($) {
    ...
    $(window).on("load", function() {
        ...
        if (typeof babystreet_supersized_conf !== "undefined") {
            ...
            for (var i = 0; i < babystreet_supersized_conf.images.length; i++) {
                imagesArr[i] = {
                    image: babystreet_supersized_conf.images[i]
                }
            }
            $.supersized({
                slideshow: 1,
    ...
    $(document).ready(function() {
        ...
        if (typeof babystreet_quickview !== "undefined") {
            $(document).on("click", "a.babystreet-quick-view-link", function(e) {
                ...
                var data = {
                    action: "babystreet_quickview",
                    productid: product_id
                };
                $.post(babystreet_quickview.babystreet_ajax_url, data, function(response) {
                    $.magnificPopup.open({
    ...
    $.BabystreetAjaxSearch.prototype = {
        ...
        execute_search: function(e) {
            ...
            if (!results.length) results = $('<div class="ajax_search_result"></div>').appendTo(form);
...
if (typeof babystreet_map_config !== "undefined") {
    ...
    function initializeCnt() {
        ...
        var marker = new google.maps.Marker({
            ...
            map: mapCnt,
            shadow: shadow,
            title: babystreet_map_config.location_title,
            icon: image
        });
        toggleBounce();
