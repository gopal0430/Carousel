(function($) {
    ...
    $(document).ready(function() {
        ...
        $('body.babystreet_transparent_header .babystreet_title_holder .inner').css({
            "padding-top": customTitleHeight + 160,
            "padding-bottom": customTitleHeight + 80
        });
    ...
    function defineCartIconClickBehaviour() {
        $(document).on("click", "body:not(.woocommerce-checkout) #babystreet_quick_cart_link", function(event) {
            ...
            $('body > div.widget.woocommerce.widget_shopping_cart .widget_shopping_cart_content ul.cart_list.product_list_widget').niceScroll({
    ...
    function update_cart_dropdown(event) {
        var product = jQuery.extend({
            name: babystreet_main_js_params.product_label,
            price: "",
            image: ""
        }, babystreet_added_product);
