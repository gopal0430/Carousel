jQuery(document).ready((function($) {
    $(".sp-testimonial-free-section").each((function(index) {
        ...
        if ("1" == _this.data("preloader")) {
            var parents_class, parents_siblings_id = $("#" + custom_id).parent(".sp-testimonial-free-wrapper").find(".sp-testimonial-preloader").attr("id");
            setTimeout((function() {
                $("#" + parents_siblings_id).animate({
                    opacity: 1
                }, 600).hide()
            }), 600), $("#" + custom_id).animate({
                opacity: 1
            }, 600)
        }
        ...
        if (SliderData && !$("#" + SliderId + ".sp-testimonial-free-section").hasClass("swiper-initialized")) {
            ...
            (!1 === SliderData.autoplay || $(window).width() < 576 && 0 == SliderData.autoplay_mobile) && TestimonialSwiper.autoplay.stop(), SliderData.pauseOnHover && SliderData.autoplay && $("#" + SliderId).on({
                mouseenter: function() {
